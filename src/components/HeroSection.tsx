        ...
        <div className="grid items-center gap-12 py-16 lg:grid-cols-2 lg:gap-16 lg:py-24">
          ...
          <div className="max-w-xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-sm border border-primary/30 bg-primary/5 px-4 py-1.5">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider text-primary">Built on Solana</span>
            </div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
              Clipchain is a decentralized SocialFi protocol on Solana that transforms short video clips into Digital Clip Assets (DCA) with real on-chain ownership and creator rewards.
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 border-t border-primary/20 pt-8">
              ...
              <div>
                <p className="font-display text-2xl font-bold text-secondary lg:text-3xl">Solana</p>
                <p className="mt-1 text-sm text-muted-foreground uppercase tracking-wider">Blockchain</p>
              </div>
              <div>
